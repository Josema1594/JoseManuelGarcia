          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="space-y-4 lg:space-y-6">
              <div className="flex items-center space-x-3 lg:space-x-4">
                ...
                <span className="text-base lg:text-lg text-gray-700">contacto@miportfolio.com</span>
              </div>
              ...
              <div className="flex items-center space-x-3 lg:space-x-4">
                ...
                <span className="text-base lg:text-lg text-gray-700">+34 123 456 789</span>
              </div>
              ...
              <div className="flex items-center space-x-3 lg:space-x-4">
                ...
                <span className="text-base lg:text-lg text-gray-700">Madrid, España</span>
              </div>
            </div>
            ...
            <div className="pt-4 lg:pt-6">
              ...
              <div className="flex space-x-4 lg:space-x-6">
                <a href="#" className="w-10 h-10 lg:w-12 lg:h-12 bg-blue-600 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors">
