const Education = () => {
  const education = [
    ...
    {
      id: 3,
      degree: "Curso de React y Node.js",
          ...
          {education.map((edu, index) => (
            <div key={edu.id} className="relative">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start space-y-4 sm:space-y-0 sm:space-x-6">
                {/* Icono de educación */}
                <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-green-500 rounded-full flex items-center justify-center mx-auto sm:mx-0">
